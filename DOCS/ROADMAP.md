...
- [ ] **TRADE_ROUTES.md** - Karavany, lodě, obchodní stezky

#### Fáze 2: Domény a politika
- [x] ~~**DOMAINS.md**~~ - Dokončeno
- [ ] **DOMAIN_ACTIONS.md** - Detailní popis všech akcí domén
- [ ] **DIPLOMACY.md** - Vztahy mezi doménami, smlouvy, aliance
- [ ] **LEGITIMACY.md** - Nároky, tituly, dědictví, casus belli

#### Fáze 3: Konflikt
- [x] ~~**WARFARE.md**~~ - Dokončeno
- [ ] **ESPIONAGE.md** - Špionáž, tajemství, intriky

#### Fáze 4: Magie a nadpřirozeno
- [ ] **MAGIC.md** - Magický systém, krystaly, očarování, akademie

#### Fáze 5: Postavy a příběh
- [x] ~~**CHARACTERS.md**~~ - Dokončeno
- [ ] **EVENTS.md** - Náhodné události, rozhodnutí, příběhy

#### Fáze 6: Systémové mechaniky
- [ ] **TIME.md** - Časový systém, roční období, tahy
- [ ] **SIMULATION.md** - Jak engine počítá jednotlivé kroky simulace
