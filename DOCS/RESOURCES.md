...
měříme jejich nominální hodnotu. Postupně je utrácíme.

### Zlato

Slouží jako univerzální platidlo.

### Vliv

Díky vlivu je možné dosahovat politických cílů a legalizovat chování.

## Ostatní zdroje

Doména nemusí mít k těmto zdrojům přístup. Přístup ke zdroji lze následujícími způsoby:

- Vlastnictvím místa, kde se zdroj nachází,
- Obchodem s doménou, která přístup má,
- Obchodem na černém trhu (velmi drahé)

Ostatní zdroje mohou generovat základní zdroje nebo odemykat nové možnosti.
...
Ložiska krystalů je možné najít v horách či v divočině. Ta království, která mají přístup k těmto zdrojům mají předpoklad pro to, aby jejich armády byly vyzbrojeny lepšími magickými zbraněmi. Jedná se tedy o velmi žádanou surovinu. Přístup ke zdroji znamená přístup ke kouzlům.
...
Železo je základní kov užívaný k výrobě zbraní, zbrojí a nástrojů.
Jedná se o nejrozšířenější kov na Astarogu a jeho dostupnost je klíčová pro rozvoj armád i hospodářství.
Železné doly se nacházejí především v horských a kopcovitých oblastech.
Práce v železných dolech je poměrně bezpečná, ale stále hrozí riziko důlních neštěstí.

Železo samo o sobě nemá vysokou hodnotu, ale jeho zpracování v kovářských dílnách vytváří zbraně, nástroje a další výrobky, které jsou základem každé prosperující domény.

### Cín

Cín je měkký kov, který se používá především ve slitinách.
Kombinace cínu a mědi vytváří bronz, který je tvrdší než oba původní kovy.
Cín se také používá k pocínování železných předmětů, čímž je chrání před rzí.

Naleziště cínu se vyskytují v horských oblastech a jsou poměrně vzácná, což z cínu činí důležitou obchodní komoditu.

### Měď

Měď je všestranný kov s charakteristickou červenohnědou barvou.
Používá se k výrobě oběživa (měděné mince), ve slitinách s cínem tvoří bronz a s zinkem mosaz.
Měď je také důležitá pro výrobu nádob, šperků a dekorativních předmětů.

Měděné doly se nacházejí v horských a kopcovitých oblastech.
Díky své relativní dostupnosti a mnohostrannosti je měď jedním z nejobchodovanějších kovů.

### Olovo

Olovo je těžký, měkký kov šedé barvy.
Využívá se v instalatérství pro výrobu potrubí, k výrobě střeliva a jako materiál pro pečetě a závaží.
Olovo je také důležité pro stavebnictví, kde se používá k izolaci a ochraně střech.

Práce s olovem může být nebezpečná kvůli jeho jedovatosti.
Dlouhodobé vystavení olovu způsobuje otravu, která se projevuje slabostí, zmateností a v těžkých případech i smrtí.
Horníci v olověných dolech proto mívají kratší život.

### Obilí

Obilná pole jsou hlavním zdrojem potravy pro lidské populace.
Pěstování obilí vyžaduje úrodnou ornou půdu a vhodné klimatické podmínky.
Nejvhodnější terény pro zemědělství jsou roviny, říční údolí a mírně zvlněná krajina.

Obilí je základem výživy většiny osad.
Vesnice a města jsou závislá na pravidelných dodávkách obilí, které se zpracovává na mouku a pečivo.
Nedostatek obilí vede k hladomorům, nepokojům a úpadku populace.

Produkce obilí je sezónní - sklizeň probíhá na podzim, zatímco na jaře a v zimě jsou zásoby nejnižší.
Chytré domény si vytvářejí zásoby v sýpkách, aby přečkaly období nedostatku.

### Pastviny

Pastviny poskytují mix živočišných produktů - mléko, mléčné výrobky a maso.
Chov dobytka, ovcí a koz vyžaduje travnaté oblasti s dostatkem vody.
Nejvhodnější jsou louky, stepi a mírně kopcovitá krajina.

Pastevectví je méně náročné na kvalitu půdy než zemědělství, ale vyžaduje větší rozlohu.
Produkty z pastvin jsou luxusnějším zdrojem potravy než obilí a bohatší populace je preferuje.

Produkce je nejvyšší na jaře a v létě, kdy je dostatek čerstvé pastvy.
V zimě produkce klesá a zásoby sušeného masa a sýrů jsou klíčové pro přežití.

### Ryby

Loviště ryb jsou důležitým zdrojem potravy pro pobřežní a říční osady.
Rybolov je možný podél mořského pobřeží, u jezer a podél velkých řek.

Ryby jsou rychle se kazícím zbožím, což omezuje jejich transport do vnitrozemí.
Sušené a solené ryby však mohou být skladovány a obchodovány na velké vzdálenosti.

Rybolov je závislý na počasí a ročním období.
V létě je produkce nejvyšší, zatímco v zimě, kdy zamrzají vodní plochy, je lov omezený nebo nemožný.
Práce rybářů je nebezpečná - bouře, převržení lodí a utonutí jsou běžnými riziky.
